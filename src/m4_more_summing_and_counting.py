...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 4
    answer = count_cosines_from(1, 10, 0)
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(5, 10, .5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(7, 10, .2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 3
    answer = count_cosines_from(-5, 5, .3)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.28333333  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 5)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = .478968254  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 10)
